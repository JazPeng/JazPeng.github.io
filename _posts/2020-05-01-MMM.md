...
My first resource for sentiment analysis was [Text Mining with R](https://www.tidytextmining.com/) (Silge and Robinson 2016). This publication talked about three lexicons; the two I decided would work for my purpose were:
...
The package [sentimentr](https://cran.r-project.org/web/packages/sentimentr/sentimentr.pdf) (Rinker 2019) measures sentence-level sentiment by taking into account valence shifters such as negation, amplifiers and deamplifiers.
```{r}
