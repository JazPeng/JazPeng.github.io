...
## Next steps
In my [next post](http://localhost:4000/meghan_markle_headline_analysis/), I'll be performing analysis on the text itself, finally displaying my results in a Tableau Public dashboard.
